...
class ChannelEventDetail(BaseModel):
    ...
    one_of_schemas: List[str] = Literal["ChildCreatedEvent", "ForcedNotificationChangedEvent", "NameChangedEvent", "ParentChangedEvent", "PinAddedEvent", "PinRemovedEvent", "SubscribersChangedEvent", "TopicChangedEvent", "VisibilityChangedEvent"]
